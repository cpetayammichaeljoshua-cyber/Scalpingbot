...
DISPERSION_LOW_CORR    = 0.20    # v18.79: 0.22→0.20 — stricter low-corr threshold; MacroGlide apex: ρ<0.20 confirms true dispersion regime, reduces false positives
DISPERSION_HIGH_CORR   = 0.88    # v18.77: 0.85→0.88 — widen systemic risk spike threshold
DISPERSION_QUALITY_BUY = 5.0    # v18.77: 4.0→5.0 — stronger boost when dispersion regime confirmed
DISPERSION_QUALITY_RISK = -5.0  # quality penalty when correlation spike detected
DISPERSION_MIN_ASSETS  = 4      # v18.77: 5→4 — work with smaller baskets in low-liquidity sessions
