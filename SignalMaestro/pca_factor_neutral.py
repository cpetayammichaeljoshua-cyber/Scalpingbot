...
PCA_N_COMPONENTS   = 3        # v18.77: 2→3 — neutralise 3 PCs (market + sector + momentum beta)
PCA_RECOMPUTE_EVERY = 60      # v18.77: 72→60 — recompute more frequently for crypto regime shifts
PCA_TOP_QUARTILE   = 0.80     # v18.77: 0.75→0.80 — tighter top quintile for alpha signals
PCA_BOT_QUARTILE   = 0.20     # v18.77: 0.25→0.20 — tighter bottom quintile for short alpha
PCA_QUALITY_BOOST  = 6.0      # v18.79: 5.0→6.0 — stronger reward for pure idiosyncratic alpha (MacroGlide apex calibration)
PCA_BETA_PENALTY   = -3.0     # quality pts when factor loading dominates (β>0.90)
PCA_MIN_SYMBOLS    = 8        # v18.77: 10→8 — allow PCA on smaller universes (off-hours)
