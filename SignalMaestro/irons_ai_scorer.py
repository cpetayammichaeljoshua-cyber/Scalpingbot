    ...
    def score(
        ...
        if macd_line is not None and macd_sig is not None:
            ...
            if is_long:
                ...
                elif hist > -abs(hist)*0.3:       mads, madn = 42, f"MACD hist={hist:.5g} weakening"
        ...
        raw = mom_avg * 0.25 + trd_avg * 0.30 + vol_avg * 0.20 + vum_avg * 0.25
        # Blend with swarm consensus (calibrated signal quality)
        swarm_pct = min(swarm_consensus * 100, 95)
        final = int(raw * 0.65 + swarm_pct * 0.35)
