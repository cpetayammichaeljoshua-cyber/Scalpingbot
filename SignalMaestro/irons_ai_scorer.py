...
def format_irons_panel(
    ...
    """
    Build the IRONS AI-style formatted Telegram message (Unity-compatible).
    Stays under 4096 characters. Unity parses the structured block; analytics
    ...
    # ── Unity-compatible block (strictly parsed by Unity bot) ──
