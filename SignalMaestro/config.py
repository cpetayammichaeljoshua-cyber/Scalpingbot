...
class Config:
    ...
    def __init__(self):
        ...
        # Unity Configuration
        self.CCXT_EXECUTOR_URL = os.getenv("CCXT_EXECUTOR_URL", "")
        self.UNITY_BOT_UUID = os.getenv("UNITY_BOT_UUID", "")
    ...
    def get_all_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'executor': {
                'webhook_url': self.CCXT_EXECUTOR_URL,
                'bot_uuid': self.UNITY_BOT_UUID
            },
            'database': {
