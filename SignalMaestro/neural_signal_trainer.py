...
INPUT_DIM          = 295  # v56 (v126.0): 290 + 5 QualitySlopeNorm+OFIVolSync+EVRingPercentile+PnLStability+WRMomentumTier features = 295 (quality_slope_norm, ofi_vol_sync, ev_ring_percentile, pnl_stability, wr_momentum_tier)
