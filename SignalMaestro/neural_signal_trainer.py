...
INPUT_DIM          = 300  # v57 (v127.0): 295 + 5 HMMRegimeNorm+SharpeEVVelocity+ARCConsensusNorm+OFIPersistenceNorm+SVCConfluenceNorm features = 300 (hmm_regime_norm, sharpe_ev_velocity, arc_consensus_norm, ofi_persistence_norm, svc_confluence_norm)
