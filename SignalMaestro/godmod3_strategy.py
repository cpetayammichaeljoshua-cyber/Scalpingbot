...
_TIER1_MODELS: List[str] = [
    ...
    # REMOVED: qwen/qwen3-235b-a22b:free → 404 confirmed live log 2026-05-13 [v18.68] (tried to add, instant 404 on boot)
...
_TIER2_MODELS: List[str] = [
    # REMOVED: qwen/qwq-32b:free                      → 404 confirmed LIVE session 2 2026-04-19
    # REMOVED: mistralai/mistral-nemo:free             → 404 confirmed LIVE session 2 2026-04-19
    # REMOVED: deepseek/deepseek-v3-0324:free          → generic errors (confirmed LIVE 2026-04-19)
    # REMOVED: nvidia/llama-3.3-nemotron-super-49b-v1:free → 404 (confirmed LIVE 2026-04-19)
    # REMOVED: arcee-ai/trinity-large-preview:free     → 404 confirmed LIVE 2026-05-03 (10+ consecutive restarts, model permanently gone from free tier)
    "qwen/qwen3-coder:free",                           # Qwen3 Coder 480B — JSON-tuned, confirmed working
]
...
_TIER3_MODELS: List[str] = [
    ...
    # REMOVED: google/gemma-3-27b-it:free → 404 confirmed 2026-05-07 live log (disabled 24h on every restart)
]
...
PRIMARY_MODEL = "meta-llama/llama-3.3-70b-instruct:free"   # Confirmed working (2026-04-19)
...
ULTRAPLINIAN_TIERS: Dict[str, List[str]] = {
    ...
    "standard": [
        ...
        # REMOVED: arcee-ai/trinity-large-preview:free → 404 permanently (2026-05-03)
        # REMOVED: google/gemma-3-27b-it:free → 404 confirmed 2026-05-07
    ...
    "smart": [
        ...
        # REMOVED: qwen/qwen3-235b-a22b:free → 404 confirmed live log 2026-05-13 [v18.68]
        # REMOVED: meta-llama/llama-4-scout:free → 404 confirmed live log 2026-05-08 [v18.33]
        # REMOVED: deepseek/deepseek-r1:free → 404 confirmed live log 2026-05-08 [v18.37] (added v18.35, 404 on first v18.36 boot — disabled 24h per restart)
        "qwen/qwen3-coder:free",
        "cognitivecomputations/dolphin-mistral-24b-venice-edition:free",
        "z-ai/glm-4.5-air:free",
    ],
    "power": [
        # Full confirmed-working pool — validated 2026-05-09 [v18.46]
        ...
        # REMOVED: qwen/qwen3-235b-a22b:free → 404 confirmed live log 2026-05-13 [v18.68]
        # REMOVED: meta-llama/llama-4-scout:free → 404 confirmed live log 2026-05-08 [v18.33]
        # REMOVED: deepseek/deepseek-r1:free → 404 confirmed live log 2026-05-08 [v18.37] (added v18.35, 404 on first v18.36 boot)
        "qwen/qwen3-coder:free",
        "cognitivecomputations/dolphin-mistral-24b-venice-edition:free",
        "z-ai/glm-4.5-air:free",
    ],
...
GODMODE_COMBOS = [
    ...
    {
        "id": "GODMODE_CODER_MOMENTUM",
        # REPLACED: qwen/qwen3-14b:free → 404 (2026-04-19 session 1)
        # REPLACED: qwen/qwq-32b:free   → 404 (2026-04-19 session 2)
        # qwen/qwen3-coder:free: JSON-tuned, fastest confirmed working, 480B MoE
        "model": "qwen/qwen3-coder:free",
        "system": (
            "You are a momentum-focused trading signal engine. Identify trend strength and "
            "breakout/breakdown setups from price action. Think through EMA alignment, "
    ...
    # REMOVED: GODMODE_QWEN3_235B_MACRO (qwen/qwen3-235b-a22b:free) → 404 confirmed live log 2026-05-13 [v18.68]
]
...
class G0DM0D3Engine:
    ...
    _CONSORTIUM_MIN_MODELS   = 4      # v8.4: 5→4 — CONSORTIUM requires 4 available models.
    ...
    async def _run_consortium_mode(
        ...
        # They queue through _csem (3 concurrent, v5.4) and _gsem (4 concurrent, v5.4) for rate control.
        consortium_tasks = [
            asyncio.wait_for(
