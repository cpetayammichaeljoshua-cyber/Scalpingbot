...
class G0DM0D3Engine:
    ...
    async def analyze(
        ...
        system_prompt = (
            ...
            "Volume_ratio 1.2-2.5 + directional OFI = institutional conviction (>2.5 = overextension trap). "
            ...
            "VPIN: <0.35 = uninformed retail flow → favorable adverse selection environment, mild confidence boost. "
