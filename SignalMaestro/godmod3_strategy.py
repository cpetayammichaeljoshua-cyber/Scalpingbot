...
_TIER2_MODELS: List[str] = [
    ...
    "arcee-ai/trinity-large-preview:free",             # Arcee Trinity Large (131K ctx) — confirmed working
]
...
_TIER4_MODELS: List[str] = [
    "google/gemma-3-12b-it:free",                      # Gemma 3 12B — lightweight & accurate, confirmed working
...
ULTRAPLINIAN_TIERS: Dict[str, List[str]] = {
    ...
    "power": [
        # Full confirmed-working pool — validated 2026-04-19 session 3/4
...
_STORM_BACKOFF_STEP       = 7      # v8.4: 10→7 — backoff now fires at storm=14 (2nd disable
                                   # cycle), not storm=20. With threshold=7, pattern is:
                                   # storm=7→120s, storm=14→240s, storm=21→480s, storm=28→960s
