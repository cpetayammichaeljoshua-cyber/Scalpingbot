# Unity Engine v18.80 — Sovereign CCXT Trading Bot
...
- **Intelligence:** SOVEREIGN [1.00] all tiers · pytorch_transformer=1.00 · sklearn=1.00 · ZERO DEGRADED 0.75
...
- pytorch_transformers must show SOVEREIGN [1.00], NEVER DEGRADED (0.75)
- sklearn must show SOVEREIGN [1.00] — never 0.75 or DEGRADED
- Backtesting overfitting probability (PBO 1000-rep Bailey & Lopez de Prado) integrated
- Workflow named exactly "python3 start_unity_engine.py" must exist
- All 7 MacroGlide quant modules: HMM, VPIN, Kalman, Dispersion, PCA, CSM, IVCrush fully active
- AEON-7/Qwen3.6-27B-AEON-Ultimate-Uncensored-DFlash integrated in SmartLLMRouter
- Vibe-Trading (HKUDS) vibeagent pool fully active at Layer 8.5V
