# ═══════════════════════════════════════════════════════════════════════════════
# Unity Engine v83.0 — Multi-stage Production Dockerfile
# Optimised for Railway.app deployment
#
# Build:  docker build -t unity-engine:83.0 .
...
print('OK Unity Engine v83.0 — SOVEREIGN [1.00] dependency singularity verified')
VERIFY
...
LABEL maintainer="Unity Engine Bot" \
      version="83.0"               \
      description="Unity Engine v83.0 — G8.5P2-EVCrisisQuality | Kelly42-EVCrisisDeSizing | NN-v20-115feat | 50-gate | CONSORTIUM-MIN_VOTES1 | G8.5O2-WinRateEVCoh | GODMODE-StructuralVortex+MacroNexus | ZERO-BYPASS-STRICT | torch==2.3.1+cpu | ZERO DEGRADED"
