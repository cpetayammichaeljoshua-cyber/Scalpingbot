# ═══════════════════════════════════════════════════════════════════════════════
# Unity Engine v18.56 — Multi-stage Production Dockerfile
# Optimised for Railway.app deployment
#
# Build:  docker build -t unity-engine:18.56 .
...
LABEL maintainer="Unity Engine Bot" \
      version="18.56"                \
      description="Unity Engine v18.56 — Strict torch install (no silent fallback); SOVEREIGN [1.00]; SCAN_PARALLEL 45→50; NN_GATE 0.40→0.39; Markov death-spiral fix; Kelly Step 20 ×1.15; EV 26→24bps; Quality floor 57→56"
